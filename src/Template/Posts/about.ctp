 <?php echo $this->element('subcontent_header'); ?>
      ...
      <section id="intro" class="clearfix">
        <div class="container">
          ...
          <div class="intro-info">
            ...
            <div>
              <a href="#abouts" class="btn-get-started scrollto">Who are we?</a>
              <a href="#organization" class="btn-services scrollto">Our Organization</a>
            </div>
          </div>
      ...
      <!-- 
        ...
        <?php foreach($data as $data_key=>$data_value) {
                if($data_value['category_id'] == '2' && $data_value['homepage'] == false) { 
          ?>
        <section id="abouts">
            <div class="container">
                <div class="row">
        ...
        <section id="organization">
            <div class="container">
                <div class="row">
                    <h2 class="subtitle text-center">Our Organization</h2>
                    <div class="col-md-3">
